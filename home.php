                            ...
                            <div class="row border border-primary">
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        `status_id`='1' ORDER BY `end_date` DESC");
                                            ...
                                            <div class="card col-6 col-lg-2 mt-2 mb-2 bg-dark border" style="width: 18rem;">
                                                ...
                                                <div class="card-body ms-0 m-0 text-center">
                                                    <h5 class="card-title"><?php echo $product_data["heading"]; ?></span></h5>
                                                        ...
                                                        <h4 class="card-text text-danger fw-bold"><?php echo $product_data["name"]?></h4>
                                                        <span class="card-text text-success fw-bold"> Set Date</span><br />
                                                        <h5><?php echo $product_data["set_date"]; ?></h5> 
                                                        <span class="card-text text-success fw-bold"> End Date</span>
                                                        ...
                                                        <a href='<?php echo "updateobjective.php?id=$s "?>' class="col-12 btn btn-warning mt-2 fw-bold">Edit</a>
                                                        <button class="col-12 btn btn-danger mt-2" onclick="del('<?php echo($s)?>');">Delete</button>
            ...
            <div class="modal-content bg-dark text-white">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <textarea name="" id="desp" cols="45" rows="10" readonly class="bg-dark text-white" style="font-size: 20px ;"></textarea>
